  ...
  return (
    <div className="flex w-full">
      <div className="w-full sm:w-2/3 pt-6 px-4 lg:pl-24">
        ...
        <h1 className="mt-8 text-4xl font-bold capitalize leading-[50px] text-black lg:text-3xl lg:leading-[35px]">
          Congratulations ✨
        </h1>
        <h2 className="my-6 text-2xl font-medium capitalize text-black">
          You have just taken the leap to propel <br />
          your career further!
        </h2>
        <p className="text-black/8 mb-4">
        ...
        <div className="flex cursor-pointer items-center justify-center space-x-2">
          {Array.from({length: 4}, (v, idx) => (
            <span
              ...
              className={cn(
                "h-4 rounded-full",
                idx === 3 ? "w-8 bg-deluge-600" : "w-4 bg-deluge-200",
              )}
            />
          ))}
        </div>
