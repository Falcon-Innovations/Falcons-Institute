...
import GuyWithLaptop from '../public/GuyWithLaptop.png';
  ...
  return (
    <div className="w-full flex">
      <div className="w-full sm:w-2/3 pt-6 px-4 sm:pl-16 lg:pl-24">
        ...
        <h1 className="capitalize mt-8 text-black font-bold text-3xl lg:text-4xl leading-9 lg:leading-[50px]">Empowering people through
