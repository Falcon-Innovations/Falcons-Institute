...
export const SubscribeToNewsletter = () => {
    return (
        <section className='px-4 relative py-6 sm:px-8 sm:py-16 text-white flex flex-col bg-blue-500 sm:flex-row items-center w-full mx-auto'>
            <Image
                src="patterns.svg"
            ...
            />
            <Container classNames='text-white  flex flex-col bg-blue-500 sm:flex-row items-center'>
